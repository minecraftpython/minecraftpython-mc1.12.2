    ...
    public void doWork() {
        for (int i = 0; i < amountToSpawn; i++) {
            ...
            if (safelyGetParticleEnum() != null)
                Minecraft.getMinecraft().renderGlobal.spawnParticle(safelyGetParticleEnum().getParticleID(), true, xPlusOrMinusOneHalf, yPlusOrMinusOneHalf, zPlusOrMinusOneHalf, 0d, 0d, 0d);
        }
    }
